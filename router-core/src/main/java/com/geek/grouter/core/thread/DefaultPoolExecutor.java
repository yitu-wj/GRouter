package com.geek.grouter.core.thread;
...
public class DefaultPoolExecutor {
    private static final ThreadFactory threadFactory=new ThreadFactory() {
        ...
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable,"GRouter #"+atomicInteger.getAndIncrement());
        }
    };
    //核心线程和最大线程都是cpu核心数+1
    ...
    public static ThreadPoolExecutor newDefaultPoolExecutor(int corePoolSize){
        ...
        ThreadPoolExecutor threadPoolExecutor=new ThreadPoolExecutor(corePoolSize,
                corePoolSize,SURPLUS_THREAD_LIFE,TimeUnit.SECONDS,new ArrayBlockingQueue<Runnable>(64),threadFactory);
        //核心线程也会被销毁
